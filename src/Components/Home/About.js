const About = () => {
  return (
    <section className='p-3 p-sm-5 px-lg-0 py-lg-5 row align-items-center justify-content-center gap-4 gx-0'>
       <div className='col-12 col-lg-5 text-center'>
          <img className="rounded w-100 common-border" src='/images/Home/About.jpg' alt='No-Image'/>
       </div>
