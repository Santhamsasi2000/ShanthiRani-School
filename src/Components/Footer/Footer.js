    ...
    <section className='footer mt-5 px-5 py-5 row gy-4 gy-sm-5 justify-content-between'>
       ...
       <div className='col-6 col-lg-4 d-none d-sm-flex flex-column align-items-end align-items-center'>
            <div className='fw-semibold fs-5 d-flex flex-column align-items-start'>
              ...
              <NavLink className="text-decoration-none mb-2">Admission Process</NavLink>
              <NavLink className="text-decoration-none mb-2">Admission Enquiry</NavLink>
              <NavLink className="text-decoration-none mb-2">Students</NavLink>
              <NavLink className="text-decoration-none mb-2">Fees Structure</NavLink>
              <NavLink className="text-decoration-none mb-2">Online Payment</NavLink>
              <NavLink className="text-decoration-none mb-2">Facilities</NavLink>
            </div>
       </div>
       <div className='col- col-lg-5 col-xl-4'>
         ...
         <div className="mb-2 d-flex gap-3 align-items-center">
          ...
          target="_blank" 
          rel="noopener noreferrer" className="email text-decoration-none lh-lg fw-semibold"><span className="">XMJ8+GGX, Kallal, Tamil Nadu 630305</span></a>
         </div>
         <div className="mb-3 d-flex gap-3 align-items-center">
              <i className="fs-1"><IoMailOpenOutline /></i>
              <a href={`mailto:shanthirani@gmail.com`} className="mt-1 text-decoration-none fw-semibold">shanthirani@gmail.com</a>
         </div>
         <div className="d-flex gap-3 align-items-center">
              <i className="fs-2"><LuPhoneCall /></i>
              <a  href={`tel:8508525062`} className="ms-2 text-decoration-none fw-semibold">8508525062</a>
            <a  href={`tel:04565284919`} className="text-decoration-none fw-semibold">04565284919</a>
         </div>
       </div>
    </section>
  ) 
