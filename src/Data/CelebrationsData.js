export const CelebrationsData = [
    {
        id:1,
        image:"/images/AboutUs/Celebrations/INVESTITURE3.jpg",
    ...
    {
        id:2,
        image:"/images/AboutUs/Celebrations/Independence.jpg",
    ...
    {
        id:3,
        image:"/images/AboutUs/Celebrations/Teacher.jpg",
        title:"TEACHER'S DAY",
    ...
    {
        id:4,
        image:"/images/AboutUs/Celebrations/Children.jpg",
    ...
    {
        id:5,
        image:"/images/AboutUs/Celebrations/Diwali.jpg",
    ...
    {
        id:5,
        image:"/images/AboutUs/Celebrations/Christmas.jpg",
        title:"CHRISTMAS CELEBRATION",
        desc:"Experience the joy of Christmas and the excitement of New Year at Shanthi Rani School! Our vibrant celebrations include festive decorations, cultural performances, carol singing, and a spirit of togetherness. Join us as we welcome the New Year with hope, gratitude, and inspiring resolutions, creating cherished memories for our students and community."
    },
    {
        id:6,
        image:"/images/AboutUs/Celebrations/Pongal.jpg",
        title:"PONGAL CELEBRATION",
        desc:"Shanthi Rani school celebrated the pongal celebrations in a splendid manner. The day started with our traditional pongal song. The students participated in various competitions and did a magnificent job to make laurels to the pongal celebrations. The real festivity unfurled itself when the children had been offered a variety of fun games right after a graceful Pongal preparation competition by our beloved higher secondary children. The music crew of Shanthi Rani performed many folk songs with instruments that entertained the students. Higher secondary students played ‘Uriyadi’ and had sweet pongal. The teachers prepared delicious pongal and it was distributed to the students."
    },
    {
        id:7,
    ...
    {
        id:8,
        image:"/images/AboutUs/Celebrations/Blessing.jpg",
        title:"BLESSING DAY",
    ...
    {
        id:9,
        image:"/images/AboutUs/Celebrations/Fields.jpg",
    ...
    {
        id:10,
        image:"/images/AboutUs/Celebrations/Quiz.jpg",
    ...
    {
        id:11,
        image:"/images/AboutUs/Celebrations/PTM.jpg",
